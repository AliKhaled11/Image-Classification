...
This project uses convolutional neural network to train an image classifier that is able to identify 102 different flower species with 88% testing accuracy. This image classifier can be used to identify flower species from new images, e.g., in a phone app that tells you the name of the flower your camera is looking at.
...
2. Build and train the model
    ...
    - Load a pre-trained network `vgg16` ([reference](https://arxiv.org/ftp/arxiv/papers/1705/1705.03004.pdf)) and freeze parameters
